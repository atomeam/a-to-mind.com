...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CZYrsoKJ.mjs");
...
var manifest = { "7555f183bc5f0cbb90424326c94d2d8da79984248d371712db9f0f0cb46468b8": {
	functionName: "draftReleaseNote_createServerFn_handler",
	importer: () => import("./evaluator-C9Si2srE.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BSsvBPi5.mjs").then((n) => n.t),
